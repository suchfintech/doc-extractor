"""CompanyExtract agent factory — corporate-registry extracts."""
...
def create_company_extract_agent(provider: str | None = None) -> Agent:
    """Construct a CompanyExtract extraction agent.
